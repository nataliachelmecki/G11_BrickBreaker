...
HD_PWD='D:/IPs/graphics_module/graphics_module.runs/design_1_framebuffer_write_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_framebuffer_write_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_framebuffer_write_0_0.tcl
