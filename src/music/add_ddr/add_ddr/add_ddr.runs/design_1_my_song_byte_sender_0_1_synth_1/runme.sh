...
HD_PWD='C:/Users/chelmec4/add_ddr/add_ddr/add_ddr.runs/design_1_my_song_byte_sender_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_my_song_byte_sender_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_my_song_byte_sender_0_1.tcl
